...
<div class="m-12 text-sm leading-normal">
    ...
    <div>
        <div class="">
            <div class="">
                ...
                <p>
                    {!! trans('livewire-cookie-consent::texts.settings_text', [ 'policyUrl' =>
                    config("livewire-cookie-consent.policy_url_$locale")]) !!}
                </p>
                ...
                <form wire:submit.prevent="acceptUserSettings">
                    ...
                    <div>
                        <label>
                            ...
                            <span
                                class="font-bold ml-1">@lang('livewire-cookie-consent::texts.setting_essential')</span>
                        </label>
                        <p>
                    ...
                    <div>
                        <label>
                            ...
                            <span
                                class="font-bold ml-1">@lang('livewire-cookie-consent::texts.setting_functional')</span>
                        </label>
                        <p>
                    ...
                    <div>
                        <label>
                            <input wire:model="analyticsCookies" type="checkbox">
                            <span
                                class="font-bold ml-1">@lang('livewire-cookie-consent::texts.setting_analytics')</span>
                        </label>
                        <p>
                    ...
                    <div>
                        <label>
                            <input wire:model="marketingCookies" type="checkbox">
                            <span
                                class="font-bold ml-1">@lang('livewire-cookie-consent::texts.setting_marketing')</span>
                        </label>
                        <p>
                    ...
                    <div class="flex flex-items justify-end">
                        ...
                        {{-- gtm-cookie-button is trigger in gtm --}}
                        <button
                            class="gtm-cookie-button inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition"
