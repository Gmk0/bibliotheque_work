                    ...
                    <form action="">
                        <div class="row">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="" id="" aria-describedby="textHelpId" placeholder="abc@mail.com">
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="row card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="" id="" aria-describedby="textHelpId" wire:model.defer="work.sujet">
                      </div>
                      <div class="mb-3">
                          <label for="" class="form-label">Catgeorie <span>*</span></label>
                          <select wire:model.defer="work.categorie" class="form-control" name="" id="">
                      ...
                      <div class="mb-3 ">
                          ...
                          <select wire:model.defer="work.domaine" class="form-control" name="" id="">
                      ...
                      <div class="mb-3 ">
                          ...
                          <select wire:model.defer="work.faculte" class="form-control" name="" id="">
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <input wire:model.defer="work.annee"  type="text" class="form-control" name="" id="" aria-describedby="textHelpId">
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="" class="form-label">Nombres Page<span>*</span></label>
                          <input wire:model.defer="work.page"  type="text" class="form-control" name="" id="" aria-describedby="textHelpId">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Etudiant<span>*</span></label>
                            <input  wire:model.defer="work.etudiant" type="text" class="form-control" name="" id="" aria-describedby="textHelpId">
                          </div>
                          <div class="mb-3">
                            <label for="" class="form-label">FILE <span>*</span></label>
                            <input wire:model.defer="file"  type="file" class="form-control" name="" id="" aria-describedby="textHelpId">
