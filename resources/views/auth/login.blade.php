<x-guest-layout>
    ...
    <!-- component -->
    <div class="relative py-6 bg-gradient-to-br from-sky-50 to-gray-200">
                ...
                <div class="rounded-xl bg-white shadow-xl">
                    <div class="p-3 sm:p-16">
                        ...
                        <div class="space-y-4 items-center">
                            <img src="{{url('images/logo2.png')}}" loading="lazy" width="90" alt="tailus logo">
                            <h2 class="mb-4 text-2xl text-cyan-900 font-bold">Sign to start your session </h2>
                        </div>
